...
def test_transaction_update():
    ...
    assert transaction.output[sender_wallet.address] ==\
        sender_wallet.balance-next_amount - first_amount
    ...
    assert transaction.output[sender_wallet.address] ==\
        sender_wallet.balance-next_amount - first_amount - to_first_again_amount
