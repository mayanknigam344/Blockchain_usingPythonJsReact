class TransactionPool:
    ...
    def transaction_data(self):
        """
        Return the transactions of the transaction pool represented in json serialized form.
        """
        return list(map(
    ...
    def clear_blockchain_transactions(self,blockchain):
        """
        Delete the blockchain recorded transactions from the transaction pool.
        """
